PROJECT_NAME=data-model-transformer
VERSION=latest
...
docker build --no-cache --build-arg GIT_BRANCH=$GIT_BRANCH --build-arg NB_PROC=$NB_PROC -t $PROJECT_NAME:$VERSION -f Dockerfile ./..
